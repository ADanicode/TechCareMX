...
export default function WhatsAppFloat({ href }: WhatsAppFloatProps) {
	return (
		<motion.a
			...
			className="fixed bottom-5 right-4 z-50 flex items-center gap-2 rounded-full border border-cyan-300/20 bg-slate-950/78 px-3 py-3 text-sm font-semibold text-white shadow-[0_14px_40px_rgba(8,47,73,0.5)] backdrop-blur-xl transition-colors hover:border-cyan-300/40 sm:bottom-7 sm:right-6"
			...
			whileTap={{ scale: 0.98 }}
		>
			<span className="flex h-11 w-11 items-center justify-center rounded-full bg-linear-to-br from-emerald-400 to-cyan-400 text-slate-950">
			...
			<span className="hidden 2xl:inline">Cotizar por WhatsApp</span>
		</motion.a>
	);
}